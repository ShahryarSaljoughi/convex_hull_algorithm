...
void find_next_vertices(const list<point> points, point &l, point &r, const point& p_top, bool right_reached, bool left_reached){
...
vector<point> my_algo_v3(vector<point> &input){
	...
	while(left_vertex != p_top or right_vertex != p_top){
		...
		find_next_vertices(points, left_vertex, right_vertex, p_top, right_reached, left_reached);	
